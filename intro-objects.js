...
var getFullNames = function(inputarray) { 
    ...
    outputarray.push(inputarray[i].first + " " + inputarray[i].last)
...
dog["speak"] = function(inputstring) {
    ...
    inputstring = inputstring.replace(0,"r")
    for (var i = 0; i< inputstring.length; i ++) {
        if (inputstring[i] === " ") {
            inputstring = inputstring.replace(inputstring[(i + 1)], "r")
        } 
    }
    
   inputstring = inputstring.replace(inputstring[0],"r")
    return inputstring
}
...
var pluck = function(inputarray,inputkey) {
    ...
    for(var i = 0; i < inputarray.length; i ++) {
          ...
          outputarray.push(inputarray[i][inputkey])  
